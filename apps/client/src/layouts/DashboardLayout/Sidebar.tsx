...
export function Sidebar() {
    ...
    return (
        <aside
            className={`fixed top-0 left-0 h-screen bg-white shadow-lg transition-all duration-300 z-40 ${isCollapsed ? "w-16" : "w-64"
                } flex flex-col`}
        >
            {/* Logo */}
                        ...
                        {item.children ? (
                            <div className="flex flex-col">
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-colors text-gray-700 hover:bg-gray-100 ${isCollapsed ? "justify-center" : ""
                                        }`}
                                >
                                    ...
                                    {!isCollapsed && (
                                        <svg
                                            className={`w-4 h-4 transition-transform duration-300 ${expandedMenus[item.label] ? "rotate-180" : ""
                                                }`}
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                ...
                                <div
                                    className={`grid transition-all duration-300 ease-in-out ${expandedMenus[item.label]
                                            ...
                                            {item.children.map((child) => (
                                                <NavLink
                                                    ...
                                                    className={({ isActive: linkActive }) =>
                                                        `flex items-center px-3 py-2 text-sm rounded-lg transition-colors ${isCollapsed ? "justify-center" : ""
                                                        } ${linkActive
